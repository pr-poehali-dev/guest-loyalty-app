    ...
    <div className="pt-5 space-y-5 animate-fade-in">
      ...
      <div className="space-y-3">
        {[
          ...
          { icon: "⭐", title: "Отзыв после проживания",    desc: "Оставьте отзыв о вашем отдыхе",                   bonus: "+500 б" },
          { icon: "👥", title: "Приведи друга",             desc: "Ваш друг забронирует впервые — оба получат бонус", bonus: "+2000 б" },
          { icon: "🎂", title: "День рождения",             desc: "Подарок от нас в ваш праздник",                   bonus: "+3000 б" },
          { icon: "📱", title: "Регистрация в программе",   desc: "Приветственные бонусы за вступление",             bonus: "+1000 б" },
        ].map(item => (
